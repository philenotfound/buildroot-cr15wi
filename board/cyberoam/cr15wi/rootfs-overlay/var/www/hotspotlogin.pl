...
<html>
<head>
  <title>PepperSpot Login Failed</title>
...
print "</head>
<body bgColor = '#c0d8f4'>";
  print "<h1 style=\"text-align: center;\">Logging in to PepperSpot</h1>";
  print "
  <center>
    Please wait......
  </center>
...
<body bgColor = '#c0d8f4'>
  <h1 style=\"text-align: center;\">PepperSpot Login Failed</h1>
  <center>
    Login must be performed through PepperSpot daemon.
  </center>
</body>
</html>
";
...
<head>
  ...
  <SCRIPT LANGUAGE=\"JavaScript\">
    ...
    function popUp(URL) {
      if (self.name != \"pepperspot_popup\") {
        pepperspot_popup = window.open(URL, 'pepperspot_popup', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=500,height=375');
      }
    }
    ...
    function doOnLoad(result, URL, userurl, redirurl, timeleft) {
      ...
      if ((result == 1) && (self.name == \"pepperspot_popup\")) {
        doTime();
      }
      if ((result == 1) && (self.name != \"pepperspot_popup\")) {
        pepperspot_popup = window.open(URL, 'pepperspot_popup', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=500,height=375');
      ...
      if ((result == 2) && (self.name != \"pepperspot_popup\")) {
        pepperspot_popup = window.open('', 'pepperspot_popup', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=400,height=200');
        pepperspot_popup.close();
      }
      if ((result == 12) && (self.name == \"pepperspot_popup\")) {
        doTime();
        if (redirurl) {
      ...
      if ((result == 13) && (self.name == \"pepperspot_popup\")) {
        self.focus();
        blur = 1;
      }
    }
...
if ($result == 1) {
  print "
  <h1 style=\"text-align: center;\">Logged in to PepperSpot</h1>";
...
if (($result == 3) || ($result == 13)) {
    print "
  <h1 style=\"text-align: center;\">Logged out from PepperSpot</h1>
  <center>
